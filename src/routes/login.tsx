...
const AUTH_CSS = `
.nho-auth{display:flex;min-height:calc(100vh - 76px);background:#fdf8f0;font-family:'Onest','Inter',system-ui,sans-serif}
.nho-auth-panel-left{width:46%;padding:50px 60px;color:#fff;display:flex;flex-direction:column;justify-content:space-between;
 background:linear-gradient(160deg,#2c1a00 0%,#5a3500 50%,#f19100 100%);position:relative;overflow:hidden}
...
.nho-auth-panel-left blockquote span{color:#ffc84a}
...
.nho-auth-stats strong{font-family:'Playfair Display',serif;font-size:1.6rem;color:#ffc84a}
...
.nho-auth-tabs{display:flex;background:#ede7da;border-radius:50px;padding:5px;margin-bottom:28px}
.nho-auth-tabs button{flex:1;padding:11px;border:0;background:transparent;border-radius:50px;font:inherit;font-size:.9rem;font-weight:500;color:#8a7050;cursor:pointer;transition:.25s}
.nho-auth-tabs button.is-on{background:#f19100;color:#fff;box-shadow:0 4px 14px rgba(241,145,0,.4)}
.nho-auth-title{font-family:'Playfair Display',serif;font-size:1.7rem;color:#1a1208;margin:0 0 6px}
.nho-auth-desc{color:#8a7050;font-size:.9rem;margin:0 0 22px}
...
.nho-auth-form label{display:flex;flex-direction:column;gap:6px;font-size:.78rem;font-weight:600;text-transform:uppercase;letter-spacing:.5px;color:#3d2e0e}
.nho-auth-form input{padding:12px 14px;border:1.5px solid #ddd3c0;border-radius:11px;font:inherit;font-size:.93rem;background:#fff;outline:none;transition:.2s}
.nho-auth-form input:focus{border-color:#f19100;box-shadow:0 0 0 3px rgba(241,145,0,.15)}
.nho-auth-submit{margin-top:6px;padding:13px;border:0;border-radius:11px;font:inherit;font-weight:600;font-size:.95rem;color:#fff;cursor:pointer;
 background:linear-gradient(135deg,#f19100,#ffc84a);box-shadow:0 6px 20px rgba(241,145,0,.4);transition:.25s}
.nho-auth-submit:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 10px 26px rgba(241,145,0,.5)}
.nho-auth-submit:disabled{opacity:.7;cursor:not-allowed}
.nho-auth-divider{display:flex;align-items:center;gap:12px;margin:18px 0;color:#8a7050;font-size:.78rem}
.nho-auth-divider::before,.nho-auth-divider::after{content:"";flex:1;height:1px;background:#ddd3c0}
.nho-auth-google{width:100%;display:flex;align-items:center;justify-content:center;gap:10px;padding:12px;border:1.5px solid #ddd3c0;border-radius:11px;background:#fff;font:inherit;font-size:.9rem;font-weight:500;color:#3d2e0e;cursor:pointer;transition:.2s}
.nho-auth-google:hover{border-color:#f19100;background:#fff9f0}
.nho-auth-back{margin-top:22px;text-align:center;font-size:.82rem;color:#8a7050}
.nho-auth-back a{color:#c97200;font-weight:600;text-decoration:none}
