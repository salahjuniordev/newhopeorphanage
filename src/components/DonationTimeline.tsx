...
function dotColor(e: string, s: string | null) {
  ...
  if (e === "created" || e === "provider_accepted") return "#FF6D00";
  return "#828282";
}
...
const TIMELINE_CSS = `
.nho-tl{margin-top:26px;text-align:left;background:#FFFFFF;border:1px solid #EFEFEF;border-radius:16px;padding:18px 20px;font-family:'Onest','Inter',system-ui,sans-serif}
...
.nho-tl-head strong{font-size:.78rem;letter-spacing:.6px;text-transform:uppercase;color:#4A4A4A}
...
.nho-tl-row time{color:#828282;font-size:.74rem;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}
.nho-tl-body p{margin:2px 0 0;color:#4A4A4A;font-size:.86rem;line-height:1.4}
`;
